	...
	aboutMenuItem.addEventListener("click", function(e) {
        var aboutWindow = Titanium.UI.createWindow({
        	...
        	lblText: 'Gustafson presents a formula, amongst others, based Thiem, of inflow to a tunnel, with and without sealing. '
        		...
        		+ 'The size of ξ is usually unknown (SKB, Äspö, Sweden). Ongoing precipitation in fissures may also be present. Generally, a rule of thumb is that the inflow q(r) ≈ K(r)·H and that q(inj) ≈ 2·p·K(inj)·H for steady state conditions. '
