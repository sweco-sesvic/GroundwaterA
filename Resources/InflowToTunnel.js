...
var lbl4 = Titanium.UI.createLabel({
	text: 'Mean permeability Kinj (<-FIXA) \nof sealed zone (m/s): ',
	left: 5,
	font:{fontSize:fontSize,fontWeight:'bold',fontFamily:'Helvetica Neue'},
	color: textColor
});
...
var resultLbl4 = Titanium.UI.createLabel({
	text: 'Approximate influence distance Rsealed/Runsealad: ',
	font:{fontSize:fontSize,fontWeight:'bold',fontFamily:'Helvetica Neue'},
	color: textColor,
	width: '90%',
	left: 5
	...
	aboutMenuItem.addEventListener("click", function(e) {
        var aboutWindow = Titanium.UI.createWindow({
        	...
        	lblText: 'Gustafson presents a formula, amongst others, based Thiem, of inflow to a tunnel, with and without sealing. '
        		...
        		+ 'The size of ξ is usually unknown (SKB, Äspö, Sweden). Ongoing precipitation in fissures may also be present. Generally, a rule of thumb is that the inflow qr ≈ Kr·H and that qinj(FIXA) ≈ 2·p·Kinj(FIXA)·H for steady state conditions. '
        		+ '\nThus, the inflow reduction level qinj(FIXA)/qr is about 2·π·Kinj(FIXA)/Kr . Hence, the uncertainty of the permeability of the sealing is critical to the prediction of inflow for the steady state to a sealed tunnel. '
        		+ 'Additionally, the combined (Kinj(FIXA) + ξ)-effect can be compared to the design-Kin(FIXA), from the magnitude of the actual inflow. The formula should be used with caution. The calculation error of inflow without sealing may well be large. '
        		...
        		+ '\nThe influence radius reduction is proportional to (qinj(FIXA)/qr(FIXA)) to a linear tunnel, but proportional to √(qinj(FIXA)/qr(FIXA)) for a single well.'
        		+ '\n\nSee, for instance:'
        		+ '\nGustafson G., Hydrogeology for Rock Engineers (ITALIC), ISRM, BeFo, 2012.'
        		+ '\nCashman & Preene, Groundwater Lowering in Construction, A Practical Guide to Dewatering (ITALIC), CRC, 2013.'
        		+ '\nHeuer, R.E. , Estimating rock-tunnel water inflow, Proceeding of the Rapid Excavation and Tunneling Conference (ITALIC), June 18-21, 1995.'
        		+ '\nSKB (Swedish Nuclear Fuel and Waste Company) (ITALIC), Site Investigations at Äspö, Sweden.'
     	});
